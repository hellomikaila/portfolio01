...
<?php
//set your email here:
$yourEmail = 'me@mikailaweaver.com';
/*
 * CONTACT FORM
 */
    ...
    <div id="form_processing">
        ...
        <?php if(isset($emailSent) && $emailSent == true) { ?>
            <div class="alert-success" >
                ...
                <p><?php echo'Your message was sent. I get back to you as soon as possible.' ?></p>
        ...
        <?php if(isset($hasError) && $hasError == true) { ?>
            <div class="alert-danger">
                ...
                <p><?php echo'Want to try that again? It looks like we are missing something.'; ?>
